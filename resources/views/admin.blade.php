...
>
    ...
    <div class="banner">
        @if( Auth::user()->is_admin == 1)
            @if(Request::url() == 'http://localhost/laravel/public/adminzone/main')
                @yield('menu')
            @endif
            @if(Request::url() == 'http://localhost/laravel/public/adminzone/categories')
                @yield('catList')

            @endif
            @if(Request::url() == 'http://localhost/laravel/public/adminzone/users')
                @yield('allUsers')
            @endif
            @if(Request::url() == 'http://localhost/laravel/public/adminzone/goods')
                @yield('allGoods')
            @endif
            @if(Request::url() == 'http://localhost/laravel/public/adminzone/orders')
                @yield('allOrders')
            @endif
        @endif
    </div>
