    ...
    <div class="container">
        <div class="header-top-in">
            ...
            <ul class="support">
                ...
                <li><span><i class="glyphicon glyphicon-earphone" class="tele-in"> </i>0 44 555 22 31</span></li>
            </ul>
...
>
    ...
    <div class="banner">
        @if( Auth::user()->is_admin == 1)
            @if($_SERVER['HTTP_REFERER'] == 'http://localhost/laravel/public/adminzone/categories')
                @yield('catEdit')
            @endif
            @if($_SERVER['HTTP_REFERER'] == 'http://localhost/laravel/public/adminzone/users')
                @yield('userEdit')
            @endif
            @if($_SERVER['HTTP_REFERER'] == 'http://localhost/laravel/public/adminzone/goods')
                @yield('goodEdit')
            @endif
        @endif
    </div>
